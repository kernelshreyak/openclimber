...
export var jump_impulse = 27
export var jump_impulse_higher = 40
...
func unhandled_input(event: InputEvent) -> void:
	...
	if event.is_action_pressed("jumphigh"):
		player.climb(false)
		_state_machine.transition_to("Move/Air", { velocity = velocity, jump_impulse = jump_impulse_higher })
